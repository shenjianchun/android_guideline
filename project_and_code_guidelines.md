...
> reference : https://github.com/ribot/android-guidelines
...
- [2 Code guidelines](#2-code-guidelines)
  * [2.1 Java language rules](#21-java-language-rules)
    + [2.1.1 Don't ignore exceptions](#211-don-t-ignore-exceptions)
    + [2.1.2 Don't catch generic exception](#212-don-t-catch-generic-exception)
    + [2.1.3 Don't use finalizers](#213-don-t-use-finalizers)
